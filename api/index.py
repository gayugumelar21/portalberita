...
def home():
    ...
    data = {
        ...
        'metadeskripsi': 'Puing Berita terpercaya dengan informasi terkini dan akurat. Temukan berita terbaru seputar politik, ekonomi, teknologi, dan olahraga. Update setiap hari dengan konten berkualitas.'
    }
